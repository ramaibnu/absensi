               ...
               <tbody>
                    ...
                    if (!empty($sert)) {
                         ...
                         foreach ($sert as $list) {
                              ...
                              echo "<a class='btn btn-success btn-sm' href ='" . base_url('./berkasSertifikasi/') . $list['auth_sertifikat'] . "' target='_blank' title='Tampilkan file sertifikat'> <i class='fas fa-file-alt'></i> </a> ";
