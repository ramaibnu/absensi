        ...
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar mt-3">
                ...
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'poh' ||
                                                        $this->uri->segment(1) == 'tambah_poh' ? 'active pcoded-trigger' : '' ?>"><a href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i class="feather icon-check-square"></i></span><span class="pcoded-mtext">Data
                            SIMPER</span></a>
                    <ul class="pcoded-submenu">
                        <li <?= $this->uri->segment(1) == 'jenis_sim_polisi' ||
                                $this->uri->segment(1) == 'tambah_jenis_sim_polisi' ? 'class="active"' : '' ?>><a href="<?= base_url('jenis_sim_polisi') ?>">Jenis SIM Polisi</a></li>
                ...
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'karyawan' ||
                                                        ...
                                                        $this->uri->segment(1) == 'tambah_nonaktif_karyawan' ? 'active pcoded-trigger' : '' ?>"><a href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Data Karyawan</span></a>
                    <ul class="pcoded-submenu">
