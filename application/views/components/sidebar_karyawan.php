    ...
    <div class="navbar-wrapper">
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar mt-3">
                <li class="nav-item <?= $this->uri->segment(1) == 'dashboard_main' || $this->uri->segment(1) == 'dashboard_datatables' ? 'active' : '' ?>">
                    <a href="<?= base_url('dashboard_main') ?>" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-<?= $this->session->userdata('akses_apps_hcdata') == 'ALL' ? 'globe' : 'tablet' ?>"></i></span><span class="pcoded-mtext"><?= $this->session->userdata('akses_apps_hcdata') == 'ALL' ? 'Dashboard' : 'Beranda' ?></span></a>
                </li>
                ...
                <li class="nav-item pcoded-hasmenu">
                    <a href="javascript:void(0);" class="nav-link has-ripple"><span class="pcoded-micon"><i
                                class="feather icon-arrow-up-right"></i></span><span class="pcoded-mtext">Shortcut</span></a>
                ...
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'perusahaan' || 
                    ...
                    $this->uri->segment(1) == 'tambah_perusahaan' || 
                    $this->uri->segment(1) == 'edit_perusahaan' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('perusahaan') ?>">Perusahaan</a></li>
                        <li <?= $this->uri->segment(1) == 'struktur' || 
                    $this->uri->segment(1) == 'tambah_struktur' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('struktur') ?>">Struktur Perusahaan</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'departemen' || 
                    $this->uri->segment(1) == 'tambah_departemen' ||
                    $this->uri->segment(1) == 'posisi' || 
                    $this->uri->segment(1) == 'tambah_posisi' ||
                    $this->uri->segment(1) == 'level' || 
                    $this->uri->segment(1) == 'tambah_level' ||
                    $this->uri->segment(1) == 'golongan' || 
                    $this->uri->segment(1) == 'tambah_golongan' ? 'active pcoded-trigger' : '' ?>">
                    ...
                    $this->uri->segment(1) == 'tambah_departemen' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('departemen') ?>">Departemen</a></li>
                        <li <?= $this->uri->segment(1) == 'section' || 
                    $this->uri->segment(1) == 'tambah_section' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('section') ?>">Section</a></li>
                        <li <?= $this->uri->segment(1) == 'posisi' || 
                    $this->uri->segment(1) == 'tambah_posisi' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('posisi') ?>">Posisi</a></li>
                        <li <?= $this->uri->segment(1) == 'level' || 
                    $this->uri->segment(1) == 'tambah_level' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('level') ?>">Level</a></li>
                        <li <?= $this->uri->segment(1) == 'grade' || 
                    $this->uri->segment(1) == 'tambah_grade' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('grade') ?>">Grade</a></li>
                        <li <?= $this->uri->segment(1) == 'golongan' || 
                    $this->uri->segment(1) == 'tambah_golongan' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('golongan') ?>">Golongan</a></li>
                        <li <?= $this->uri->segment(1) == 'status_perjanjian' || 
                    $this->uri->segment(1) == 'tambah_status_perjanjian' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('status_perjanjian') ?>">Status Perjanjian</a></li>
                        <li <?= $this->uri->segment(1) == 'roster' || 
                    $this->uri->segment(1) == 'tambah_roster' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('roster') ?>">Roster</a></li>
                        <li <?= $this->uri->segment(1) == 'bank' || 
                    $this->uri->segment(1) == 'tambah_bank' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('bank') ?>">Bank</a></li>
                        <li <?= $this->uri->segment(1) == 'sanksi' || 
                    $this->uri->segment(1) == 'tambah_sanksi' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('sanksi') ?>">Sanksi</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'lokasi_kerja' || 
                    $this->uri->segment(1) == 'tambah_lokasi_kerja' ||
                    $this->uri->segment(1) == 'poh' || 
                    $this->uri->segment(1) == 'tambah_poh' ? 'active pcoded-trigger' : '' ?>"><a
                        href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-map"></i></span><span class="pcoded-mtext">Data
                            Daerah</span></a>
                    <ul class="pcoded-submenu">
                        <li <?= $this->uri->segment(1) == 'lokasi_kerja' || 
                    $this->uri->segment(1) == 'tambah_lokasi_kerja' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('lokasi_kerja') ?>">Lokasi Kerja</a>
                        </li>
                        <li <?= $this->uri->segment(1) == 'lokasi_penerimaan' || 
                    $this->uri->segment(1) == 'tambah_lokasi_penerimaan' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('lokasi_penerimaan') ?>">Lokasi Penerimaan</a>
                        </li>
                        <li <?= $this->uri->segment(1) == 'poh' || 
                    $this->uri->segment(1) == 'tambah_poh' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('poh') ?>">Point of Hire</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'poh' || 
                    $this->uri->segment(1) == 'tambah_poh' ? 'active pcoded-trigger' : '' ?>"><a
                        href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-check-square"></i></span><span class="pcoded-mtext">Data
                            SIMPER</span></a>
                    <ul class="pcoded-submenu">
                        <li <?= $this->uri->segment(1) == 'jenis_sim_polisi' || 
                    $this->uri->segment(1) == 'tambah_jenis_sim_polisi' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('jenis_sim_polisi') ?>">Jenis SIM Polisi</a></li>
                        <li <?= $this->uri->segment(1) == 'unit' || 
                    $this->uri->segment(1) == 'tambah_unit' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('unit') ?>">Unit</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-menu-caption">
                ...
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'karyawan' || 
                        ...
                        $this->uri->segment(1) == 'tambah_nonaktif_karyawan' ? 'active pcoded-trigger' : '' ?>"><a
                        href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        $this->uri->segment(1) == 'edit_karyawan' || 
                        $this->uri->segment(1) == 'detail_karyawan' || 
                        $this->uri->segment(1) == 'tambah_karyawan' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('karyawan') ?>">Karyawan</a></li>
                        <li <?= $this->uri->segment(1) == 'nonaktif_karyawan' || 
                        $this->uri->segment(1) == 'tambah_nonaktif_karyawan' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('nonaktif_karyawan') ?>">Non-Aktif
                                Karyawan</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'pelanggaran' || 
                    ...
                    $this->uri->segment(1) == 'update_pelanggaran' ? 'active pcoded-trigger' : '' ?>"><a
                        href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-alert-triangle"></i></span><span class="pcoded-mtext">Data
                            Pelanggaran</span></a>
                    <ul class="pcoded-submenu">
                        <li <?= $this->uri->segment(1) == 'pelanggaran' || 
                    $this->uri->segment(1) == 'tambah_pelanggaran' || 
                    $this->uri->segment(1) == 'detail_pelanggaran' || 
                    $this->uri->segment(1) == 'update_pelanggaran' ? 'class="active"' : '' ?>><a
                                href="<?= base_url('pelanggaran') ?>">Pelanggaran</a></li>
                    </ul>
                </li>
                <?php
                ...
                <li class="nav-item pcoded-hasmenu <?= $this->uri->segment(1) == 'users' || 
                        $this->uri->segment(1) == 'tambah_user' ? 'active pcoded-trigger' : '' ?>"><a
                        href="javascript:void(0);" class="nav-link"><span class="pcoded-micon"><i
     ...
     <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:50%;">
          <div class="modal-content">
               ...
               <div class="modal-footer m-3">
                    <button type="button" id="verifDataKTP" class="btn font-weight-bold btn-primary" disabled>Verifikasi Data</button>
