                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input id='bank' type="text" class="form-control form-control-user bg-white"
                                    readonly><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="updateBank" class="form-label">Bank <span
                                                class="text-danger">*</span></label><br>
                                        <input style="text-transform:uppercase" type="text" class="form-control form-control-user bg-white"
                                            id="updateBank" autocomplete="off" spellcheck="false" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
