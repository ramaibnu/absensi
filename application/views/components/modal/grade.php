                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input id='level' type="text" class="form-control form-control-user bg-white"
                                    readonly><br>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label for="grade">Grade :</label><br>
                                <input id='grade' type="text" class="form-control form-control-user bg-white"
                                    readonly><br>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="updateLevel" class="form-label">Level <span
                                                class="text-danger">*</span></label><br>
                                        <select id='updateLevel' type="text" autocomplete="off" spellcheck="false"
                                            class="form-control form-control-user bg-white" required>
                                            <option value="">-- Level tidak ditemukan --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <div class="form-group">
                                        <label for="updateGrade" class="form-label">Grade <span
                                                class="text-danger">*</span></label><br>
                                        <input id='updateGrade' type="text" autocomplete="off" spellcheck="false"
