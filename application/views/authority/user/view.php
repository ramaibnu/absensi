               ...
               <div class="col-xl-12 col-md-12">
                    <div class="card latest-update-card">
                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        <a href="<?= base_url('users'); ?>" class="btn btn-primary font-weight-bold"><i class="fas fa-sync-alt"></i> Refresh / Data</a>
                                        <a href="<?= base_url('tambah_user'); ?>" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> Tambah Data</a>
                                   </div>
                              </div>
                              <div class="row">
                                   <div class="col-lg-12">
