                ...
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            ...
                            <div class="alert alert-danger err_psn_posisi animate__animated animate__bounce d-none">
                            </div>
                        </div>
                        <form action="javascript:void(0);" id="tambahPosisi" method="post" data-parsley-validate>
                            <div class="row ">
                                <?php
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="perPosisi" class="form-label">Perusahaan <span
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="depPosisi" class="form-label">Departemen <span
                                                class="text-danger">*</span></label><br>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input style="text-transform:uppercase" id='Posisi' type="text"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <textarea id='ketPosisi' type="text" autocomplete="off" spellcheck="false"
                                        class="form-control form-control-user"></textarea>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <hr class="mb-2">
                                    <button type="submit" class="btn font-weight-bold btn-primary">Simpan</button>
                                    <button type="button" name="btnBatalPosisi" id="btnBatalPosisi"
