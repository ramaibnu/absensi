                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('status_perjanjian'); ?>">
                                    Status Perjanjian
                                </a>
                            </li>
                            <li class="breadcrumb-item">
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-5">
                                <a href="<?= base_url('status_perjanjian'); ?>" class="btn btn-primary font-weight-bold"><i
                            ...
                            <div class="row ">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="status_perjanjian" class="form-label">Status Perjanjian <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='status_perjanjian' type="text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="status_waktu" class="form-label">Jangka Waktu <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control form-control-user" id="status_waktu" autocomplete="off" spellcheck="false" required>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <a href="<?= base_url('status_perjanjian') ?>" class="btn font-weight-bold btn-danger">Batal</a>
                                </div>
                                </div>
                            </div>
                        </form>
