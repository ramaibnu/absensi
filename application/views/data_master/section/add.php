            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-4">
                                <a href="<?= base_url('section'); ?>" class="btn btn-primary font-weight-bold"><i
                        ...
                        <form action="javascript:void(0);" id="tambahData" method="post" data-parsley-validate>
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="departemen" class="form-label">Departemen <span
                                                class="text-danger">*</span></label><br>
                                        <select id='departemen' name='departemen' class="form-control form-control-user"
                                            required disabled>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="kode" class="form-label">Kode Section <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='kode' type="text"
                                            data-parsley-kode-max-length="8" autocomplete="off" spellcheck="false"
                                            aria-describedby="kodeHelp" class="form-control form-control-user" required>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="section" class="form-label">Section <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='section' type="text"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <button type="reset" class="btn font-weight-bold btn-danger">Batal</button>
                                </div>
                            </div>
                        </form>
                    </div>
