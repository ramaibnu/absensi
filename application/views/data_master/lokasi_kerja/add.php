            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-4">
                                <a href="<?= base_url('lokasi_kerja'); ?>" class="btn btn-primary font-weight-bold"><i
                                        class="fas fa-sync-alt"></i> Refresh / Data</a>
                            </div>
                            <div class="alert alert-danger err_psn_lokker animate__animated animate__bounce d-none">
                            </div>
                        </div>
                        <form action="javascript:void(0)" id="tambahLokasiKerja" method="post" data-parsley-validate>
                            <div class="row ">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label for="kodeLokker" class="form-label">Kode <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='kodeLokker' name='kodeLokker'
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12">
                                    <div class="form-group">
                                        <label for="Lokker" class="form-label">Lokasi Kerja <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='Lokker' type="text"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <textarea id='ketLokker' type="text" autocomplete="off" spellcheck="false"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <button type="button" name="btnBatalLokker" id="btnBatalLokker"
