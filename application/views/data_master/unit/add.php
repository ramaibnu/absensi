            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-4">
                                <a href="<?= base_url('unit'); ?>" class="btn btn-primary font-weight-bold"><i
                        ...
                        <form action="javascript:void(0)" id="tambahUnit" method="post" data-parsley-validate>
                            <div class="row ">
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label for="KodeUnit" class="form-label">Kode Unit</label>
                                        <input style="text-transform:uppercase" id='KodeUnit' type="text"
                                            autocomplete="off" data-parsley-kode-max-length="8" spellcheck="false"
