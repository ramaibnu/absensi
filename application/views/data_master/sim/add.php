            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-5">
                                <a href="<?= base_url('sim'); ?>" class="btn btn-primary font-weight-bold"><i
                            ...
                            <div class="row ">
                                <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                    <div class="form-group">
                                        <label for="sim" class="form-label">Jenis SIM Polisi <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='sim' type="text"
