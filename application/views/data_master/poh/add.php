            ...
            <div class="col-xl-12 col-md-12">
                <div class="card latest-update-card">
                    ...
                    <div class="card-body">
                        <div class="mt-3">
                            <div class="mb-4">
                                <a href="<?= base_url('poh'); ?>" class="btn btn-primary font-weight-bold"><i
                        ...
                        <form action="javascript:void(0)" id="tambahPoh" method="post" data-parsley-validate>
                            <div class="row ">
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label for="kodePoh" class="form-label">Kode <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='kodePoh' name='kodePoh' type="text"
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12">
                                    <div class="form-group">
                                        <label for="Poh" class="form-label">Point of Hire <span
                                                class="text-danger">*</span></label>
                                        <input style="text-transform:uppercase" id='Poh' type="text" autocomplete="off"
                                            spellcheck="false" class="form-control form-control-user" value="" required>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <label for="ketPoh">Keterangan </label><br>
                                    <textarea id='ketPoh' type="text" autocomplete="off" spellcheck="false"
                                        class="form-control form-control-user"></textarea>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <hr class="mb-2">
                                    <button type="submit" class="btn font-weight-bold btn-primary">Simpan</button>
                                    <button type="button" name="btnBatalPoh" id="btnBatalPoh"
