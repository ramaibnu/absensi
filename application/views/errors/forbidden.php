...
<body>
     ...
     <div id="notfound">
          <div class="notfound">
               ...
               <p>Mohon Maaf, user ini tidak diperkenankan untuk fitur ini!</p>
               <a href="javascript:history.back()" class="btn btn-primary font-weight-bold text-white">Kembali</a>
          </div>
     </div>
