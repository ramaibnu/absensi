...
class Posisi_API_model extends CI_Model
{
    public function datatables($data, $auth)
    {
        $api_url = API_URL . 'posisi_datatables';
    ...
    {
        $api_url = API_URL . 'spesifik_posisi';
    ...
    {
        $api_url = API_URL . 'spesifik_posisi2';
