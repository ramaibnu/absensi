...
class Users_API_model extends CI_Model
{
    ...
    {
        $api_url = API_URL . 'user_datatables';
    ...
    public function reset($data, $auth)
    {
        $api_url = API_URL . 'reset_sandi';
    ...
    public function changeStatus($data, $auth)
    {
        $api_url = API_URL . 'change_status_user';
