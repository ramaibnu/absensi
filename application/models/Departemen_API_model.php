...
class Departemen_API_model extends CI_Model
{
    public function datatables($data, $auth)
    {
        $api_url = API_URL . 'departemen_datatables';
    ...
    {
        $api_url = API_URL . 'spesifik_departemen';
    ...
    {
        $api_url = API_URL . 'spesifik_departemen2';
    ...
    {
        $api_url = API_URL . 'tambah_departemen';
    ...
    {
        $api_url = API_URL . 'edit_departemen';
    ...
    {
        $api_url = API_URL . 'hapus_departemen';
