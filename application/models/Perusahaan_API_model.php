...
class Perusahaan_API_model extends CI_Model
{
    public function datatables($data, $auth)
    {
        $api_url = API_URL . 'perusahaan_datatables';
    ...
    {
        $api_url = API_URL . 'spesifik_perusahaan';
    ...
    {
        $api_url = API_URL . 'tambah_perusahaan';
    ...
    {
        $api_url = API_URL . 'edit_perusahaan';
    ...
    {
        $api_url = API_URL . 'hapus_perusahaan';
