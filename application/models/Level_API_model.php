...
class Level_API_model extends CI_Model
{
    public function datatables($data, $auth)
    {
        $api_url = API_URL . 'level_datatables';
    ...
    {
        $api_url = API_URL . 'spesifik_level';
    ...
    {
        $api_url = API_URL . 'spesifik_level2';
