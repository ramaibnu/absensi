...
class Golongan_API_model extends CI_Model
{
    public function datatables($data, $auth)
    {
        $api_url = API_URL . 'golongan_datatables';
    ...
    {
        $api_url = API_URL . 'spesifik_golongan';
    ...
    {
        $api_url = API_URL . 'tambah_golongan';
    ...
    {
        $api_url = API_URL . 'hapus_golongan';
